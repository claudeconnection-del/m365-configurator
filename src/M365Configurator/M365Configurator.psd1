@{
    ...
    FunctionsToExport = @('Get-M365RequiredModule', 'Get-M365ModuleStatus', 'Get-M365ModuleRemediation', 'Initialize-M365Module', 'Connect-M365Graph', 'Disconnect-M365Graph', 'Connect-M365ExchangeOnline', 'Disconnect-M365ExchangeOnline', 'Invoke-M365Cleanup')
    CmdletsToExport   = @()
    VariablesToExport = @()
    AliasesToExport   = @()
